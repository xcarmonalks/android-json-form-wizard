...
public class JsonFormConstants {
    ...
    public static final String RESOURCE_VIEWER = "resource_view";
    ...
    public static final String VISUALIZATION_MODE_EXTRA = "visualization";
    public static final int VISUALIZATION_MODE_EDIT = 1;
